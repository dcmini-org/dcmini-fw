...
use embassy_nrf::peripherals::{
    self, I2S, NVMC, P0_00, P0_03, P0_11, P0_12, P0_27, P0_28, P0_29, P0_30,
    P1_01, P1_02, P1_03, P1_04, P1_05, P1_06, P1_07, P1_09, P1_10, P1_11,
    P1_12, P1_13, P1_14, P1_15, PDM, PWM0, PWM1, PWM2, PWM3, QDEC, RNG, RTC1,
    RTC2, SAADC, TIMER0, TIMER1, TIMER2, TIMER3, TIMER4, TWISPI0, UARTE0,
    UARTE1, WDT,
};
...
// NOTE: Detect pin removed in SR2 revision.
...
pub struct DCMini {
    /// Pins for detecting low battery.
    pub pwstat1: Peri<'static, P1_10>,
    pub pwstat2: Peri<'static, P1_12>,
    // Charge enable pin
    pub charge_en: Peri<'static, P1_02>,
    // Enable pin for vsense measurement circuit.
    pub vsense: Peri<'static, P1_13>,
    // Analog input to measure battery voltage
    pub vdiv: Peri<'static, P0_03>, // Analog in
    /// Pin for detecting charge status
    pub power_good: Peri<'static, P1_11>,
    ...
    /// Power enable for 3.3V and 5V rails
    pub pwctl: Peri<'static, P0_29>,
