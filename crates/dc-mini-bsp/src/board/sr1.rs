...
pub struct SdCardResources {
    pub sclk: Peri<'static, peripherals::P0_02>,
    pub mosi: Peri<'static, peripherals::P0_28>,
    pub miso: Peri<'static, peripherals::P0_03>,
    pub cs: Peri<'static, peripherals::P0_30>,
    pub detect: Peri<'static, peripherals::P1_15>,
