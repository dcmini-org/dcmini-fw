...
pub async fn apply_ads_config<MutexType: RawMutex>(
    ...
    for ads_dev in frontend.ads.iter_mut() {
        ...
        let Some(num_chs) = ads_dev.num_chs else {
            return false;
        };
        let ads_chs = Range { start: 0, end: num_chs };
        for ch in ads_chs {
            ...
            ensure_ok!(ads_dev
                .modify_register(ads1299::Register::LOFF_SENSP, |reg_value| {
                    let flag = ads1299::LoffSensP::from_bits_retain(0x01 << ch);
                    let reg =
                        ads1299::LoffSensP::from_bits_retain(reg_value)
                            .difference(flag);
            ...
            ensure_ok!(ads_dev
                .modify_register(ads1299::Register::LOFF_SENSN, |reg_value| {
                    let flag = ads1299::LoffSensN::from_bits_retain(0x01 << ch);
                    let reg =
                        ads1299::LoffSensN::from_bits_retain(reg_value)
                            .difference(flag);
            ...
            ensure_ok!(ads_dev
                .modify_register(ads1299::Register::LOFF_FLIP, |reg_value| {
                    let flag = ads1299::LoffFlip::from_bits_retain(0x01 << ch);
                    let reg = ads1299::LoffFlip::from_bits_retain(reg_value)
                        .difference(flag);
            ...
            ensure_ok!(ads_dev
                .modify_register(ads1299::Register::BIAS_SENSP, |reg_value| {
                    let flag = ads1299::BiasSensP::from_bits_retain(0x01 << ch);
                    let reg =
                        ads1299::BiasSensP::from_bits_retain(reg_value)
                            .difference(flag);
            ...
            ensure_ok!(ads_dev
                .modify_register(ads1299::Register::BIAS_SENSN, |reg_value| {
                    let flag = ads1299::BiasSensN::from_bits_retain(0x01 << ch);
                    let reg =
                        ads1299::BiasSensN::from_bits_retain(reg_value)
                            .difference(flag);
